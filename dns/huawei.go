...
func (hua *Huaweicloud) DeleteAllDomainRecords(domain *config.Domain, recordType string) error {
	panic("Huaweicloud provider does not support delete operation yet for alias aggregation feature. " +
		"Please use Aliyun DNS provider (dns.name: 'alidns') for alias aggregation, " +
		"or implement the delete operation for Huaweicloud provider. " +
